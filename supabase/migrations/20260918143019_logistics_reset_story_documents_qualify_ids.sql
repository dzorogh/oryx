-- Qualify ambiguous id in store_reset_logistics_stories.
...
begin
  ...
  where customer_order_id between p_lo and p_hi
     ...
     or source_id in (
       select store_reservation.id from public.store_reservation where customer_order_id between p_lo and p_hi
     )
     or source_id in (
