...
const EMP_12: UserProfileData = {
  ...
  avatarUrl: "https://i.pravatar.cc/200?u=emp12",
  workStatus: "working",
...
const EMP_08: UserProfileData = {
  ...
  avatarUrl: "https://i.pravatar.cc/200?u=emp08",
...
const EMP_15: UserProfileData = {
  ...
  avatarUrl: "https://i.pravatar.cc/200?u=emp15",
...
const EMP_22: UserProfileData = {
  ...
  avatarUrl: "https://i.pravatar.cc/200?u=emp22",
  workStatus: "day_off",
...
const buildFallbackProfile = (userId: string): UserProfileData => {
  ...
  return {
    ...
    avatarUrl: `https://i.pravatar.cc/200?u=${userId}`,
    position,
