...
export const CANCEL_GUIDANCE_PRODUCTION_CLOSE =
  "Закрытие снимет резервы и спишет весь оставшийся незавершённый остаток; история движений сохранится. Завершённые выпуски и связанные документы не отменяются.";
