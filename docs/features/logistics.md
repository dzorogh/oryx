...
Вкладка «Товары» заказа на производство — три уровня: товар («План», «В выпусках» — черновик и в работе, «Выпущено»); разворот — выпуски с этим товаром («Количество», «Свободно», «В резерве»); разворот выпуска — строки резервов под заказ клиента или регион и «Свободно». У завершённого выпуска строки владельцев помечены «Выпущено под»: количество уже на складе.

Сценарии «создать заказ на производство под заказ клиента» сразу создают черновик выпуска на весь объём с резервом. Дополнительный резерв — в новый черновик выпуска или в свободное количество имеющегося черновика (`store_reserve_in_production_output`). Зарезервировать в черновике можно под заказ клиента или под регион (общий диалог «Зарезервировать в выпуске», данные — из контекста формы): у товара на вкладке «Товары» заказа на производство (новый выпуск или имеющийся черновик), на строке черновика выпуска там же и на свободной строке на странице выпуска. Снятие резерва в черновике — обратный перенос в «Свободно» той же операцией `store_move_in_production_output` (перераспределение между владельцами строк черновика): пункт «Снять в выпуске OUT-N» в меню строки заказа клиента, кнопка «Снять» в строке резерва на вкладке «Товары» заказа на производство и у занятой строки на странице выпуска. На странице выпуска колонка «Под что» показывает владельца строки или «Свободно»; черновик завершается кнопкой «Завершить» в шапке. Выпуск в работе и завершённый не меняются.
